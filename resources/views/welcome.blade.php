...
@section('content')
    <div class="d-flex flex-column flex-shrink-0 p-3 bg-light h-100" style="width: 18rem;">
        <a href="" onclick="event.preventDefault()" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-dark text-decoration-none" style="cursor: default">
            <span class="fs-4">Навигация</span>
        </a>
        <hr>
        <ul class="nav nav-pills flex-column mb-auto fs-5">
            <li class="nav-item side_bar_button rounded">
            ...
            <li class="nav-item side_bar_button rounded">
                <a href="{{ route('events') }}" class="nav-link text-dark">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-journal-bookmark" viewBox="0 0 16 16">
            ...
            @if(auth()->user()->role == 'teacher')
                <li class="nav-item side_bar_button rounded">
                    <a href="{{ route('events_create') }}" class="nav-link text-dark">
                ...
                <li class="nav-item side_bar_button rounded">
                    <a href="{{ route('post_create') }}" class="nav-link text-dark">
